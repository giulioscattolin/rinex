...
class SvEpochSvClockRecordV304Tokenizer extends RinexTokenizerTemplate {
    public static final int INVALID_INTEGER = -1;

    protected SvEpochSvClockRecordV304Tokenizer(RinexTokenCollector itsTokenCollector, RinexTokenizerProvider itsTokenizerProvider, RinexTokenizerDriver itsDriver) {
    ...
    private void tokenize() {
        ...
        selectTokenizer(BROADCAST_ORBIT_V304);
    }

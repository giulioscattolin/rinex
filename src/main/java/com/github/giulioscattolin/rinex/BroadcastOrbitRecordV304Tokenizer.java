...
class BroadcastOrbitRecordV304Tokenizer extends RinexTokenizerTemplate {
    private int itsOrbitNumber = 1;

    public BroadcastOrbitRecordV304Tokenizer(RinexTokenCollector tokenCollector, RinexTokenizerProvider tokenizerProvider, RinexTokenizerDriver tokenDriver) {
